    ...
    return t.prototype = {
        ...
        EventDispatcher: function (s) {
            ...
            this.off = function (t, e) {
                ...
                var i;
                if (t)
                    if (s.settings.isJQueryPlugin) $(s.DOM.originalInput).triggerHandler(t, [e]);
                    else {
                        try {
                            i = new CustomEvent(t, {
                                detail: e
        ...
        events: {
            ...
            binding: function () {
                ...
                for (var n in e && !this.listeners.main && (this.DOM.input.addEventListener(this.isIE ? "keydown" : "input", i[this.isIE ? "onInputIE" : "onInput"].bind(this)), this.settings.isJQueryPlugin && $(this.DOM.originalInput).on("tagify.removeAllTags", this.removeAllTags.bind(this))), t = this.listeners.main = this.listeners.main || {
            ...
            callbacks: {
                ...
                onEditTagInput: function (t) {
                    var e = t.closest("tag"),
                        ...
                        n = s == t.originalValue || this.validateTag(s);
                ...
                onEditTagBlur: function (t) {
                    var e, i = t.closest("tag"),
                        ...
                        a = i.isValid;
                    void 0 !== a && !0 !== a || (t.textContent = n, this.value[s].value = n, this.update(), (e = t.cloneNode(!0)).removeAttribute("contenteditable"), i.title = n, i.classList.remove("tagify--editable"), t.parentNode.replaceChild(e, t), this.trigger("edit", {
                        tag: i,
                        index: s,
                        data: this.value[s]
                    }))
        ...
        addMixTag: function (t) {
            if (t && this.state.tag) {
                for (var e, i, s, n, a = this.state.tag.prefix + this.state.tag.value, o = document.createNodeIterator(this.DOM.input, NodeFilter.SHOW_TEXT), r = 100;
                    (e = o.nextNode()) && r--;)
        ...
        addTags: function (t, e) {
            ...
            return this.DOM.input.removeAttribute("style"), t.forEach(function (t) {
                var e, i;
                t = Object.assign({}, t), "function" == typeof s.settings.transformTag && (t.value = s.settings.transformTag.call(s, t.value) || t.value), !0 !== (e = s.maxTagsReached() || s.validateTag.call(s, t.value)) && (t.class = (t.class || "") + " tagify--notAllowed", t.title = e, s.markTagByValue(t.value), s.trigger("invalid", {
                        data: t,
        ...
        dropdown: {
            ...
            show: function (t) {
                ...
                if (this.settings.whitelist.length) {
                    ...
                    e = this.dropdown.createListHTML.call(this, this.suggestedListItems), this.DOM.dropdown.innerHTML = e, this.dropdown.highlightOption.call(this, this.DOM.dropdown.querySelector(".tagify__dropdown__item")), this.dropdown.position.call(this), !this.DOM.dropdown.parentNode != document.body && (document.body.appendChild(this.DOM.dropdown), this.events.binding.call(this, !1), this.dropdown.events.binding.call(this))
                }
            },
            hide: function () {
            ...
            position: function () {
                ...
                this.DOM.dropdown.style.cssText = "top: " + (t.top + t.height - 1 + window.pageYOffset) + "px"
            ...
            events: {
                ...
                callbacks: {
                    onKeyDown: function (t) {
                        var e = this.DOM.dropdown.querySelector("[class$='--active']") || this.DOM.dropdown.children[0],
                            i = "";
                        switch (t.key) {
                            case "ArrowDown":
                            case "ArrowUp":
            ...
            highlightOption: function (t, e) {
                if (t) {
                    ...
                    }), t.classList.add(s), e && (t.parentNode.scrollTop = t.clientHeight + t.offsetTop - t.parentNode.clientHeight), this.settings.autoComplete && !this.settings.dropdown.fuzzySearch && (i = this.suggestedListItems[this.getNodeIndex(t)].value || this.input.value, this.input.autocomplete.suggest.call(this, i))
                }
            },
            filterListItems: function (t) {
                if (!t) return "";
                for (var e, i, s, n, a = [], o = this.settings.whitelist, r = this.settings.dropdown.maxItems || 1 / 0, l = 0; l < o.length && (s = (e = o[l] instanceof Object ? o[l] : {
                        value: o[l]
                    }).value.toLowerCase().indexOf(t.toLowerCase()), i = this.settings.dropdown.fuzzySearch ? 0 <= s : 0 == s, n = !this.settings.duplicates && -1 < this.isTagDuplicate(e.value), i && !n && r-- && a.push(e), 0 != r); l++);
                return a
            },
